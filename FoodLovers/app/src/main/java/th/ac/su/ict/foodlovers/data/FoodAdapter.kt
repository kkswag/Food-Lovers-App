...
class FoodAdapter(private val context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        rowView.nf.text = dataSource[position].Food
        rowView.ns.text = dataSource[position].Store
        rowView.priceWon.text = dataSource[position].price
        ...
        val drawableId: Int =
                res.getIdentifier(dataSource[position].image, "drawable", context.packageName)
